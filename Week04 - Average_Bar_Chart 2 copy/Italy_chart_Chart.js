class Italy_chart_Chart {
    constructor(_data) {
        ...
        this.title2 = "Those Aged 60+ are Most At Risk...";
        ...
        this.colors = [color('#48dbfb'), color('#48dbfb'), color('#48dbfb'), color('#48dbfb'), color('#ff5e57'), color('#ff5e57'), color('#ff5e57'), color('#ff5e57')];
    ...
    titleAge() {
        ...
        text(this.title, this.chartWidthAge / 2, -this.chartHeightAge - 15);
