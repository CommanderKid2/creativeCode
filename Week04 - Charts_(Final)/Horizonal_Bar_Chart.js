class Horizonal_Bar_Chart {
    constructor(_data) {
        ...
        this.title2 = "Population Countries Vaccinated";

        this.title = "% Percentage of Vaccinated";
        this.fontSize = 30;
    ...
    titleCovid() {
        ...
        text(this.title, this.chartWidthAge / 1.5, -this.chartHeightAge - 20);
    ...
    titleAge() {
        ...
        textSize(this.fontSize);
        textAlign(CENTER, BOTTOM);
        text(this.title2, this.chartWidth / 3, -this.chartHeight - 20);
        textFont(); //not work with font
        rotate(PI / 5);
    }
